<div class="w-1/5">
    ...
    <form wire:submit.prevent="updatePassword">
        <!-- Current Password -->
        <div class="mb-4">
            <label for="current_password" class="block text-sm font-medium text-secondary dark:text-primary">Current Password</label>
            <input
                type="password"
                id="current_password"
        ...
        <!-- New Password -->
        <div class="mb-4">
            <label for="new_password" class="block text-sm font-medium text-secondary dark:text-primary">New Password</label>
            <input
                type="password"
                id="new_password"
        ...
        <div class="mb-4">
            <label for="new_password_confirmation" class="block text-sm font-medium text-secondary dark:text-primary">Confirm New Password</label>
            <input
                type="password"
